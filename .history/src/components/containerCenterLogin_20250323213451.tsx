...
const ContainerCenterLogin = () => {
  ...
  const [errorTextMessage, setTextErrorMessage] = useState('');
    ...
    <form style={{
      ...
      <img src="/trello-right.e6e102c7 (1).svg" alt="iconPageLeft" className="iconPageLeft" />
        ...
        <div className="centerCard">
          <div >
            <label htmlFor="email" className={(errors?.email || errorMessage) ? "label-text-error" : ""}>Email *</label>
            <input 
              type="text" 
              placeholder="Email" 
              {...register('email', {
          ...
          <div>
            <label htmlFor="password" className={(errors?.password || errorMessage) ? "label-text-error" : ""}>Password *</label>
            <input 
              type="password" 
          ...
          {errorMessage && (
            <p className={errorMessage && "div-text-error"}>{errorMessage && errorTextMessage}</p>
            )}
        </div>
